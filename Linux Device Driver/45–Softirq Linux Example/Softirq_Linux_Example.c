...
*              softirq.
*           
*              1. Added Ali_Wazeer_SOFT_IRQ in interrupt.h
...
static irqreturn_t gpio_irq_handler(int irq,void *dev_id) 
{
  ...
  /* Raise the softirq */
  raise_softirq( Ali_Wazeer_SOFT_IRQ );
...
static int __init etx_driver_init(void)
{
  ...
  */ 
  ...
  /* Assign gpio_interrupt_softirq_handler to the Ali_Wazeer_SOFT_IRQ */
  open_softirq( Ali_Wazeer_SOFT_IRQ, gpio_interrupt_softirq_handler );
